...
![Ballot image1](https://cs50.harvard.edu/x/2020/psets/3/fptp_ballot_1.png)

A plurality vote would here declare a tie between Alice and Bob, since each has two votes. But is that the right outcome?

There’s another kind of voting system known as a ranked-choice voting system. In a ranked-choice system, voters can vote for more than one candidate. Instead of just voting for their top choice, they can rank the candidates in order of preference. The resulting ballots might therefore look like the below.

![Ballot image2](https://cs50.harvard.edu/x/2020/psets/3/ranked_ballot_1.png)
...
![Ballot image3](https://cs50.harvard.edu/x/2020/psets/3/condorcet_1.png)
...
![Graph1](https://cs50.harvard.edu/x/2020/psets/3/condorcet_graph_1.png)
...
![Graph2](https://cs50.harvard.edu/x/2020/psets/3/no_condorcet_1.png)
...
![Graph3](https://cs50.harvard.edu/x/2020/psets/3/lockin.png)
...
```
### References
All images from Harvard CS50 course site:[CS50/Tideman](https://cs50.harvard.edu/x/2020/psets/3/tideman/)
